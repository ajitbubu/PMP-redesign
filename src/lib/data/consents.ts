...
export const consentRecords: ConsentRecord[] = [
  {
    ...
    description: "Retrieve applicant credit score from bureaus",
  ...
  },
  {
    ...
    description: "Share income proof with underwriting",
  ...
  },
  {
    ...
    description: "Send loan repayment reminders",
  ...
  },
  {
    ...
    description: "Promote tailored loan offers",
  ...
  },
  {
    ...
    description: "Analyse in-app behaviour patterns",
    purpose: "Legitimate Interest",
    category: "Analytics",
    state: "Expired",
    consentState: "Opt-out",
  ...
  },
  {
    ...
    description: "Share offers from partner lenders",
    purpose: "Marketing Offers",
    category: "Marketing Offers",
    state: "Active",
    consentState: "Opt-in",
  ...
  },
  {
    ...
    description: "Access clinical treatment records",
    purpose: "Contractual Obligation",
    category: "Necessary",
    state: "Active",
    consentState: "Explicit",
  ...
  },
  {
    ...
    description: "Share de-identified data for research",
    purpose: "Analytics",
    category: "Analytics",
    state: "Withdrawn",
    consentState: "Opt-out",
  ...
  },
  {
    ...
    description: "Verify guardian identity for minors",
    purpose: "Legal Obligation",
    category: "Necessary",
    state: "Active",
    consentState: "Explicit",
  ...
  },
  {
    ...
    description: "Store submitted identity documents",
    purpose: "Legal Obligation",
    category: "Necessary",
    state: "Active",
    consentState: "Explicit",
  ...
  },
  {
    ...
    description: "Verify residential address proof",
    purpose: "Contractual Obligation",
    category: "Necessary",
    state: "Active",
    consentState: "Opt-in",
  ...
  },
  {
    ...
    description: "Screen against sanctions watchlists",
    purpose: "Legal Obligation",
    category: "Necessary",
    state: "Active",
    consentState: "Explicit",
  ...
  },
  {
    ...
    description: "Verify identity for card issuance",
    purpose: "Legal Obligation",
    category: "Necessary",
    state: "Active",
    consentState: "Explicit",
